...
CRYPTOCURRENCIES = [
    ...
    "USDC-USDT", "TRX-USDT", "NEAR-USDT", "MATIC-USDT", "APT-USDT",
    ...
    "WNCG-USDT", "QKC-USDT",
    "BFC-USDT", "PERP-USDT", "TVK-USDT", "BOSON-USDT", "XVG-USDT",
    "DIA-USDT", "IDEX-USDT", "KNC-USDT", "MIR-USDT", "GTC-USDT",
    "ALPHA-USDT", "CTK-USDT", "LINA-USDT", "AVA-USDT", "BOND-USDT",
    "XWC-USDT", "XPRT-USDT", "TOMO-USDT", "CUDOS-USDT", "PIVX-USDT",
    "PNT-USDT", "BLZ-USDT", "DODO-USDT", "FIDA-USDT", "LIT-USDT",
    "TRU-USDT", "AKRO-USDT", "SUPER-USDT", "VOXEL-USDT", "OM-USDT",
    "IRIS-USDT", "FIO-USDT", "KIN-USDT", "MFT-USDT", "ADX-USDT",
    "NULS-USDT", "XDC-USDT", "PRE-USDT", "SERO-USDT", "VID-USDT",
    "WAN-USDT", "GMB-USDT", "DVI-USDT", "KAI-USDT", "BEPRO-USDT",
    "DKA-USDT", "RFR-USDT", "DOCK-USDT", "MITH-USDT", "ETN-USDT"
]
